  ...
  useEffect(() => {
    fetch('/loop-header.lottie')
      ...
      .catch(error => {
        ...
        setLottieData(null); // Usa a imagem de fallback
      });
  }, []);
      ...
      <div className="container px-4 sm:px-6 lg:px-8" ref={containerRef}>
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-12 items-center">
          <div className="w-full lg:w-1/2">
            ...
            >
              Endocrinologia · Obesidade · Diabetes · Tireoide · Metabolismo
            </p>
            ...
            >
              <a 
                href="#schedule" 
                className="flex items-center justify-center group w-full sm:w-auto text-center transition-all duration-300 hover:scale-105 hover:shadow-2xl" 
                style={{
            ...
            {lottieData ? (
              ...
              <div className="relative transition-all duration-500 ease-out overflow-hidden rounded-2xl sm:rounded-3xl shadow-2xl">
                <img 
                  ref={imageRef} 
                  src="/dani-photo.jpg" 
                  alt="Dra. Daniele Ferreira - Endocrinologista especializada" 
